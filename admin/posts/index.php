...
<?php include "../../app/include/sidebar-admin.php"; ?>
        ...
        <div class="posts col-8">
            <div class="button row">
                ...
                <a href="<?php echo BASE_URL . "admin/posts/index.php";?>" class="admin-bth col-4 btn-warning">Редактировать</a>
            </div>
            ...
            <div class="row post">
                ...
                <?php if ($post['status']): ?>
                <div class="del col-2"><a href="edit.php?publish=0&pub_id=<?=$post['id'];?>">в черновик</a></div>
                <?php else: ?>
                <div class="del col-2"><a href="edit.php?publish=1&pub_id=<?=$post['id'];?>">опубликовать</a></div>
                <?php endif; ?>
            </div>
            <?php endforeach; ?>
        </div>
